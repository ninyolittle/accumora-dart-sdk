...
class Operation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$0.Any>(2, _omitFieldNames ? '' : 'metadata',
        subBuilder: $0.Any.create)
    ..aOB(3, _omitFieldNames ? '' : 'done')
    ..aOM<$1.Status>(4, _omitFieldNames ? '' : 'error',
        subBuilder: $1.Status.create)
    ..aOM<$0.Any>(5, _omitFieldNames ? '' : 'response',
        subBuilder: $0.Any.create)
  ...
  @$pb.TagNumber(2)
  set metadata($0.Any value) => $_setField(2, value);
  @$pb.TagNumber(2)
  $core.bool hasMetadata() => $_has(1);
  @$pb.TagNumber(2)
  void clearMetadata() => $_clearField(2);
  @$pb.TagNumber(2)
  $0.Any ensureMetadata() => $_ensure(1);
  ...
  @$pb.TagNumber(4)
  set error($1.Status value) => $_setField(4, value);
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set response($0.Any value) => $_setField(5, value);
  @$pb.TagNumber(5)
  $core.bool hasResponse() => $_has(4);
  @$pb.TagNumber(5)
  void clearResponse() => $_clearField(5);
  @$pb.TagNumber(5)
  $0.Any ensureResponse() => $_ensure(4);
}
...
class DeleteOperationRequest extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  DeleteOperationRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class WaitOperationRequest extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  WaitOperationRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class OperationsApi {
  ...
  $async.Future<ListOperationsResponse> listOperations(
      ...
      _client.invoke<ListOperationsResponse>(ctx, 'Operations',
          'ListOperations', request, ListOperationsResponse());
  ...
  $async.Future<Operation> getOperation(
      ...
      _client.invoke<Operation>(
          ctx, 'Operations', 'GetOperation', request, Operation());
  ...
  $async.Future<$3.Empty> deleteOperation(
      ...
      _client.invoke<$3.Empty>(
          ctx, 'Operations', 'DeleteOperation', request, $3.Empty());
  ...
  $async.Future<$3.Empty> cancelOperation(
      ...
      _client.invoke<$3.Empty>(
          ctx, 'Operations', 'CancelOperation', request, $3.Empty());
  ...
  $async.Future<Operation> waitOperation(
      ...
      _client.invoke<Operation>(
          ctx, 'Operations', 'WaitOperation', request, Operation());
}
