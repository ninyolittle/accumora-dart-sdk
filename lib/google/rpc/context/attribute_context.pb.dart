...
class AttributeContext_Auth extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$1.Struct>(4, _omitFieldNames ? '' : 'claims',
...
class AttributeContext_Response extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$2.Timestamp>(4, _omitFieldNames ? '' : 'time',
        subBuilder: $2.Timestamp.create)
    ..aOM<$3.Duration>(5, _omitFieldNames ? '' : 'backendLatency',
  ...
  @$pb.TagNumber(5)
  void clearBackendLatency() => $_clearField(5);
  @$pb.TagNumber(5)
...
class AttributeContext_Resource extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(10)
  set deleteTime($2.Timestamp value) => $_setField(10, value);
  @$pb.TagNumber(10)
...
class AttributeContext extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<AttributeContext_Peer>(7, _omitFieldNames ? '' : 'origin',
        subBuilder: AttributeContext_Peer.create)
    ..pPM<$0.Any>(8, _omitFieldNames ? '' : 'extensions',
  ...
  @$pb.TagNumber(8)
  $pb.PbList<$0.Any> get extensions => $_getList(7);
}
