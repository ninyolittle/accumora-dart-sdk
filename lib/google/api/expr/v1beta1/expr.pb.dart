...
//
// Generated from google/api/expr/v1beta1/expr.proto.
...
class ParsedExpr extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$0.SourceInfo>(3, _omitFieldNames ? '' : 'sourceInfo',
  ...
  @$pb.TagNumber(3)
  set sourceInfo($0.SourceInfo value) => $_setField(3, value);
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set syntaxVersion($core.String value) => $_setString(2, value);
  @$pb.TagNumber(4)
  $core.bool hasSyntaxVersion() => $_has(2);
  @$pb.TagNumber(4)
  void clearSyntaxVersion() => $_clearField(4);
}
...
class Expr extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  set literalExpr(Literal value) => $_setField(3, value);
  @$pb.TagNumber(3)
  $core.bool hasLiteralExpr() => $_has(1);
  @$pb.TagNumber(3)
  void clearLiteralExpr() => $_clearField(3);
  @$pb.TagNumber(3)
