...
//
// Generated from google/api/expr/v1alpha1/value.proto.
...
class Value extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$0.Any>(10, _omitFieldNames ? '' : 'objectValue',
  ...
  @$pb.TagNumber(10)
  set objectValue($0.Any value) => $_setField(10, value);
  @$pb.TagNumber(10)
...
class MapValue_Entry extends $pb.GeneratedMessage {
  ...
  factory MapValue_Entry.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory MapValue_Entry.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
...
class MapValue extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.api.expr.v1alpha1'),
      createEmptyInstance: create)
    ..pPM<MapValue_Entry>(1, _omitFieldNames ? '' : 'entries',
