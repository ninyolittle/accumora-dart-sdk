...
class ParsedExpr extends $pb.GeneratedMessage {
  ...
  factory ParsedExpr.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory ParsedExpr.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  @$pb.TagNumber(2)
  set expr(Expr value) => $_setField(2, value);
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set sourceInfo(SourceInfo value) => $_setField(3, value);
  @$pb.TagNumber(3)
  $core.bool hasSourceInfo() => $_has(1);
  @$pb.TagNumber(3)
  void clearSourceInfo() => $_clearField(3);
  @$pb.TagNumber(3)
...
class Expr_Ident extends $pb.GeneratedMessage {
  ...
  factory Expr_Ident.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory Expr_Ident.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
...
class Expr_Select extends $pb.GeneratedMessage {
  ...
  factory Expr_Select.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory Expr_Select.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  @$pb.TagNumber(1)
  void clearOperand() => $_clearField(1);
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(3)
  void clearTestOnly() => $_clearField(3);
}
...
class Expr_Call extends $pb.GeneratedMessage {
  ...
  factory Expr_Call.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory Expr_Call.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pPM<Expr>(3, _omitFieldNames ? '' : 'args', subBuilder: Expr.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  Expr_Call clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(1)
  set target(Expr value) => $_setField(1, value);
  @$pb.TagNumber(1)
...
class Expr_CreateList extends $pb.GeneratedMessage {
  factory Expr_CreateList({
    ...
    if (optionalIndices != null) result.optionalIndices.addAll(optionalIndices);
    return result;
  }

  Expr_CreateList._();

  factory Expr_CreateList.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory Expr_CreateList.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.api.expr.v1alpha1'),
      createEmptyInstance: create)
    ..pPM<Expr>(1, _omitFieldNames ? '' : 'elements', subBuilder: Expr.create)
    ..p<$core.int>(
        2, _omitFieldNames ? '' : 'optionalIndices', $pb.PbFieldType.K3)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  Expr_CreateList clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(1)
  $pb.PbList<Expr> get elements => $_getList(0);
  ...
  @$pb.TagNumber(2)
  $pb.PbList<$core.int> get optionalIndices => $_getList(1);
}
...
class Expr_CreateStruct_Entry extends $pb.GeneratedMessage {
  factory Expr_CreateStruct_Entry({
    ...
    if (mapKey != null) result.mapKey = mapKey;
    if (value != null) result.value = value;
    if (optionalEntry != null) result.optionalEntry = optionalEntry;
    return result;
  }

  Expr_CreateStruct_Entry._();

  factory Expr_CreateStruct_Entry.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory Expr_CreateStruct_Entry.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  Expr_CreateStruct_Entry clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(2)
  @$pb.TagNumber(3)
  void clearKeyKind() => $_clearField($_whichOneof(0));
  ...
  @$pb.TagNumber(3)
  set mapKey(Expr value) => $_setField(3, value);
  @$pb.TagNumber(3)
  $core.bool hasMapKey() => $_has(2);
  @$pb.TagNumber(3)
  void clearMapKey() => $_clearField(3);
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(5)
  set optionalEntry($core.bool value) => $_setBool(4, value);
  @$pb.TagNumber(5)
  $core.bool hasOptionalEntry() => $_has(4);
  @$pb.TagNumber(5)
  void clearOptionalEntry() => $_clearField(5);
}
...
class Expr_CreateStruct extends $pb.GeneratedMessage {
  ...
  factory Expr_CreateStruct.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory Expr_CreateStruct.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pPM<Expr_CreateStruct_Entry>(2, _omitFieldNames ? '' : 'entries',
        subBuilder: Expr_CreateStruct_Entry.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  Expr_CreateStruct clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(1)
  set messageName($core.String value) => $_setString(0, value);
  @$pb.TagNumber(1)
  $core.bool hasMessageName() => $_has(0);
  @$pb.TagNumber(1)
  void clearMessageName() => $_clearField(1);

  /// The entries in the creation expression.
  @$pb.TagNumber(2)
  $pb.PbList<Expr_CreateStruct_Entry> get entries => $_getList(1);
}
...
class Expr_Comprehension extends $pb.GeneratedMessage {
  factory Expr_Comprehension({
    ...
    final result$ = create();
    if (iterVar != null) result$.iterVar = iterVar;
    if (iterRange != null) result$.iterRange = iterRange;
    if (accuVar != null) result$.accuVar = accuVar;
    if (accuInit != null) result$.accuInit = accuInit;
    if (loopCondition != null) result$.loopCondition = loopCondition;
    if (loopStep != null) result$.loopStep = loopStep;
    if (result != null) result$.result = result;
    if (iterVar2 != null) result$.iterVar2 = iterVar2;
    return result$;
  }

  Expr_Comprehension._();

  factory Expr_Comprehension.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory Expr_Comprehension.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  Expr_Comprehension clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(1)
  set iterVar($core.String value) => $_setString(0, value);
  @$pb.TagNumber(1)
  $core.bool hasIterVar() => $_has(0);
  @$pb.TagNumber(1)
  void clearIterVar() => $_clearField(1);

  /// The range over which the comprehension iterates.
  @$pb.TagNumber(2)
  Expr get iterRange => $_getN(1);
  @$pb.TagNumber(2)
  set iterRange(Expr value) => $_setField(2, value);
  @$pb.TagNumber(2)
  $core.bool hasIterRange() => $_has(1);
  @$pb.TagNumber(2)
  void clearIterRange() => $_clearField(2);
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  void clearAccuVar() => $_clearField(3);

  /// The initial value of the accumulator.
  @$pb.TagNumber(4)
  Expr get accuInit => $_getN(3);
  @$pb.TagNumber(4)
  set accuInit(Expr value) => $_setField(4, value);
  @$pb.TagNumber(4)
  $core.bool hasAccuInit() => $_has(3);
  @$pb.TagNumber(4)
  void clearAccuInit() => $_clearField(4);
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  void clearLoopCondition() => $_clearField(5);
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set loopStep(Expr value) => $_setField(6, value);
  @$pb.TagNumber(6)
  $core.bool hasLoopStep() => $_has(5);
  @$pb.TagNumber(6)
  void clearLoopStep() => $_clearField(6);
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set result(Expr value) => $_setField(7, value);
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set iterVar2($core.String value) => $_setString(7, value);
  @$pb.TagNumber(8)
  $core.bool hasIterVar2() => $_has(7);
  @$pb.TagNumber(8)
  void clearIterVar2() => $_clearField(8);
}
...
class Expr extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  set constExpr(Constant value) => $_setField(3, value);
  @$pb.TagNumber(3)
  $core.bool hasConstExpr() => $_has(1);
  @$pb.TagNumber(3)
  void clearConstExpr() => $_clearField(3);
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set identExpr(Expr_Ident value) => $_setField(4, value);
  @$pb.TagNumber(4)
  $core.bool hasIdentExpr() => $_has(2);
  @$pb.TagNumber(4)
  void clearIdentExpr() => $_clearField(4);
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set selectExpr(Expr_Select value) => $_setField(5, value);
  @$pb.TagNumber(5)
  $core.bool hasSelectExpr() => $_has(3);
  @$pb.TagNumber(5)
  void clearSelectExpr() => $_clearField(5);
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  void clearCallExpr() => $_clearField(6);
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set listExpr(Expr_CreateList value) => $_setField(7, value);
  @$pb.TagNumber(7)
  $core.bool hasListExpr() => $_has(5);
  @$pb.TagNumber(7)
  void clearListExpr() => $_clearField(7);
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set structExpr(Expr_CreateStruct value) => $_setField(8, value);
  @$pb.TagNumber(8)
  $core.bool hasStructExpr() => $_has(6);
  @$pb.TagNumber(8)
  void clearStructExpr() => $_clearField(8);
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  set comprehensionExpr(Expr_Comprehension value) => $_setField(9, value);
  @$pb.TagNumber(9)
  $core.bool hasComprehensionExpr() => $_has(7);
  @$pb.TagNumber(9)
  void clearComprehensionExpr() => $_clearField(9);
  @$pb.TagNumber(9)
...
class Constant extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aE<$2.NullValue>(1, _omitFieldNames ? '' : 'nullValue',
    ...
    ..aOM<$0.Duration>(8, _omitFieldNames ? '' : 'durationValue',
        subBuilder: $0.Duration.create)
    ..aOM<$1.Timestamp>(9, _omitFieldNames ? '' : 'timestampValue',
  ...
  @$pb.TagNumber(8)
  @$pb.TagNumber(9)
  void clearConstantKind() => $_clearField($_whichOneof(0));

  /// null value.
  @$pb.TagNumber(1)
  $2.NullValue get nullValue => $_getN(0);
  @$pb.TagNumber(1)
  set nullValue($2.NullValue value) => $_setField(1, value);
  @$pb.TagNumber(1)
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(8)
  void clearDurationValue() => $_clearField(8);
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(8)
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(9)
  void clearTimestampValue() => $_clearField(9);
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(9)
...
class SourceInfo_Extension_Version extends $pb.GeneratedMessage {
  ...
  factory SourceInfo_Extension_Version.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory SourceInfo_Extension_Version.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  SourceInfo_Extension_Version clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(1)
  set major($fixnum.Int64 value) => $_setInt64(0, value);
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set minor($fixnum.Int64 value) => $_setInt64(1, value);
  @$pb.TagNumber(2)
...
class SourceInfo_Extension extends $pb.GeneratedMessage {
  ...
  SourceInfo_Extension._();

  factory SourceInfo_Extension.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory SourceInfo_Extension.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  SourceInfo_Extension clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(2)
  $pb.PbList<SourceInfo_Extension_Component> get affectedComponents =>
      $_getList(1);
  ...
  @$pb.TagNumber(3)
  set version(SourceInfo_Extension_Version value) => $_setField(3, value);
  @$pb.TagNumber(3)
...
class SourceInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..m<$fixnum.Int64, Expr>(5, _omitFieldNames ? '' : 'macroCalls',
        ...
        packageName: const $pb.PackageName('google.api.expr.v1alpha1'))
    ..pPM<SourceInfo_Extension>(6, _omitFieldNames ? '' : 'extensions',
  ...
  @$pb.TagNumber(1)
  set syntaxVersion($core.String value) => $_setString(0, value);
  @$pb.TagNumber(1)
  $core.bool hasSyntaxVersion() => $_has(0);
  @$pb.TagNumber(1)
  void clearSyntaxVersion() => $_clearField(1);
  ...
  @$pb.TagNumber(6)
  $pb.PbList<SourceInfo_Extension> get extensions => $_getList(5);
}
